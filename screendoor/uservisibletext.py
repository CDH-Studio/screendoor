...
class ToolTips():
    ...
    complementary_response_tooltip = _("""Additional information given by the applicant to explain/clarify their experience(s).
    ...
    extracts_tooltip = _("""Analysis of the applicant's complementary response provided by ScreenDoor's Natural Language Processing (NLP) model.
                      Only extracts information that can be verifiably linked to the applicant and their experience(s).""")
